...
#define SOUND_BB_KAZE_ENDCARD  /* 0xFC01FF82 */ SOUND_ARG_LOAD(SOUND_BANK_CUSTOM_BILLBOARDS, 0x02, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE | SOUND_CONSTANT_FREQUENCY)
