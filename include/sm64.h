...
enum MarioActionFlags {
    ...
    ACT_FLAG_CAN_DRINK_WATER            = /* 0x40000000 */ (1 << 30),
...
#define ACT_IDLE                       (0x0C400201 | ACT_FLAG_CAN_DRINK_WATER) // (0x001 | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_PANTING                    (0x0C400205 | ACT_FLAG_CAN_DRINK_WATER) // (0x005 | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_STANDING_AGAINST_WALL      (0x0C400209 | ACT_FLAG_CAN_DRINK_WATER) // (0x009 | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_COUGHING                   (0x0C40020A | ACT_FLAG_CAN_DRINK_WATER) // (0x00A | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
#define ACT_SHIVERING                  (0x0C40020B | ACT_FLAG_CAN_DRINK_WATER) // (0x00B | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_DRINKING_WATER             0x00000028 // (0x028)
...
#define ACT_DRINKING_WATER_FAIL        0x00000037 // (0x037)
...
#define ACT_WALKING                    (0x04000440 | ACT_FLAG_CAN_DRINK_WATER) // (0x040 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON)
#define ACT_UNUSED_041                 0x00000041 // (0x041)
#define ACT_HOLD_WALKING               0x00000442 // (0x042 | ACT_FLAG_MOVING)
#define ACT_TURNING_AROUND             (0x00000443 | ACT_FLAG_CAN_DRINK_WATER) // (0x043 | ACT_FLAG_MOVING)
#define ACT_FINISH_TURNING_AROUND      (0x00000444 | ACT_FLAG_CAN_DRINK_WATER) // (0x044 | ACT_FLAG_MOVING)
#define ACT_BRAKING                    (0x04000445 | ACT_FLAG_CAN_DRINK_WATER) // (0x045 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON)
...
#define ACT_DECELERATING               (0x0400044A | ACT_FLAG_CAN_DRINK_WATER) // (0x04A | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON)
#define ACT_HOLD_DECELERATING          (0x0000044B | ACT_FLAG_CAN_DRINK_WATER) // (0x04B | ACT_FLAG_MOVING)
...
#define ACT_SPECIAL_KB_BUS             0x0002189D // (0x09D | ACT_FLAG_AIR | ACT_FLAG_INVULNERABLE | ACT_FLAG_INTANGIBLE)
...
#define ACT_UNPROCESSED                0x0000130B // (0x10B | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE)
...
#define ACT_VEGAS_CUTSCENE             (0x0000013E | ACT_FLAG_MOVING | ACT_FLAG_INTANGIBLE) // (0x13E)
