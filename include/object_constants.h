...
#define DAY (HOUR * 24)
#define DAY_START (HOUR * 6)
#define DAY_END (HOUR * 18)
...
#define MAX_HYDRATION MINUTES_TO_FRAMES(30.0f)
#define MAX_BATTERIES MINUTES_TO_FRAMES(15.0f)
#define HYDRATION_DRAIN_RATE 1
