...
const LevelScript level_desert_entry[] = {
	...
	AREA(1, desert_area_1),
		...
		OBJECT(MODEL_KOOPA_WITH_SHELL_CUSTOM, -20936, 0, -1136, 0, 0, 0, 0x00000000, bhvKoopaCustom),
		OBJECT(MODEL_KOOPA_WITH_SHELL_CUSTOM, -20135, 0, -1136, 0, 0, 0, (1), bhvKoopaCustom),
