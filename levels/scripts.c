...
static const LevelScript goto_desert_warp[];
...
const LevelScript level_main_scripts_entry[] = {
    ...
    ALLOC_LEVEL_POOL(),
    LOAD_MODEL_FROM_GEO(MODEL_BILLBOARD_IMAGE, sign_normal_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BILLBOARD_VIDEO, sign_video_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BUS,                      bus_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_ROCK_A,                   Rock_A_geo),
    LOAD_MODEL_FROM_GEO(MODEL_ROCK_B,                   Rock_B_geo),
    LOAD_MODEL_FROM_GEO(MODEL_ROCK_C,                   Rock_C_geo),
    FREE_LEVEL_POOL(),
    POP_POOL(),
    ...
    JUMP_IF(   /*op*/ OP_EQ, /*arg*/ WARP_SPECIAL_DESERT_WARP,         goto_desert_warp),
