...
const LevelScript level_main_scripts_entry[] = {
    ...
    ALLOC_LEVEL_POOL(),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_BSM_COURSE_1, sign_video_data_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_PATCHMAKER, sign_patchmaker_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_MALTINGIUS, sign_maltingius_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_COZIES, sign_cozies_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_APPY, sign_appy_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_MOTH, sign_moth_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_SPK, sign_spk_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_OATMEAL, sign_oatmeal_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_BETTERCALLSHY, sign_bettercallshy_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_CROSS, sign_cross_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_YOUTUBE, sign_youtube_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_YUGAMINEENA, sign_yugamineena_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_BART, sign_bart_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_NINTENDO_EMPLOYEES, sign_predator_001_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_PREDATOR, sign_predator_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_MOTIVATE, sign_motivate_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_XENOGEARS, sign_xenogears_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_XENOBLADE, sign_xenoblade_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_MAKE_CLEAN, sign_make_clean_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_COMIT_ANTIS, sign_comit_antis_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_COMIT_STANS, sign_comit_stans_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_HACKERN64, sign_hackern64_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_MUSHROOM, sign_mushroom_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_COMIT, sign_comit_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_ROVERT, sign_rovert_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_MVC, sign_mvc_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_ASS_IMPACT, sign_ass_impact_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_SIMPLEFLIPS, sign_simpleflips_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_JOEL, sign_joel_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_SPOON, sign_spoon_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_FARM, sign_farm_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_CHEEZEPIN, sign_cheezepin_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SIGN_AMOGUS, sign_amogus_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BUSH, bush_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_ELECTRICAL_POLE, electrical_pole_geo),
