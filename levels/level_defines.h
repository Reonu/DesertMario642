...
DEFINE_LEVEL("DESERT", LEVEL_DESERT, COURSE_DESERT, desert, generic, 20000, 0x00, 0x00, 0x00, _, sCamDesert) 
DEFINE_LEVEL("DESERT_INTRO", LEVEL_DESERT_INTRO, COURSE_DESERT_INTRO, desert_intro, generic, 20000, 0x00, 0x00, 0x00, _, sCamDesertIntro) 
DEFINE_LEVEL("VEGAS_ENDING", LEVEL_VEGAS_ENDING, COURSE_VEGAS_ENDING, vegas_ending, generic, 20000, 0x00, 0x00, 0x00, _, sCamVegasEnding) 