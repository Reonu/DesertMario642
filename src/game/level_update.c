...
s32 lvl_set_current_level(UNUSED s16 initOrUpdate, s32 levelNum) {
	...
	if (gCurrLevelNum == LEVEL_VEGAS_ENDING) return 0;
	if (gCurrLevelNum == LEVEL_DESERT_INTRO) return 0;
	if (gCurrLevelNum == LEVEL_DESERT) return 0;
