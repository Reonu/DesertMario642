...
enum WarpOperation {
    ...
    WARP_OP_DESERT_SPAWN,
    WARP_OP_DESERT_ENDING,
    WARP_OP_DEMO_END
};
...
enum HUDDisplayFlag {
    ...
    HUD_DISPLAY_FLAG_HYDRATION_METER  = (1 <<  7), // 0x0040
#ifdef BREATH_METER
    ...
    HUD_DISPLAY_DEFAULT = (HUD_DISPLAY_FLAG_LIVES | HUD_DISPLAY_FLAG_COIN_COUNT | HUD_DISPLAY_FLAG_STAR_COUNT | HUD_DISPLAY_FLAG_CAMERA_AND_POWER | HUD_DISPLAY_FLAG_KEYS | HUD_DISPLAY_FLAG_UNKNOWN_0020 | HUD_DISPLAY_FLAG_HYDRATION_METER)
};
...
enum BillboardIDs {
    ...
    // TIER 1
    BB_SIGN_HACKERN64 = BB_BILLBOARD_START, // NOTE: BB_BILLBOARD_START equivalent should not be a video!
    BB_SIGN_MALTINGIUS,
    BB_SIGN_COZIES,
    BB_SIGN_APPY,
    BB_SIGN_MOTH,
    ...
    BB_SIGN_JOEL,
    BB_SIGN_TCS,
    BB_SIGN_STICKER_STAR,
    BB_SIGN_HYENA_ART,
    BB_SIGN_MOTH_SMOKING,
    BB_SIGN_FURYIOUSFIGHT,
    BB_SIGN_SOMEONE,
    BB_SIGN_FREE_PSP,
